...
from datasets.classifier_dataset import DeepFakeClassifierDataset
...
def main():
    ...
    new_dataset.reset(0, 1234)
    train_loader = torch.utils.data.DataLoader(new_dataset, batch_size=args.batch_size, num_workers=args.workers,
                                       shuffle=True is None, pin_memory=False,
                                       drop_last=True)
